...
const monthsData = [
  {
    ...
    color: '#C54B6C', // Deep Rose
  },
  {
    name: 'February',
    noteKey: 'note.february',
    captionKeys: ['caption.feb1', 'caption.feb2', 'caption.feb3', 'caption.feb4'],
    color: '#E8A0BF', // Rose Gold
  },
  {
    name: 'March',
    noteKey: 'note.march',
  ...
  },
  {
    name: 'April',
    noteKey: 'note.april',
    captionKeys: ['caption.apr1', 'caption.apr2', 'caption.apr3', 'caption.apr4'],
    color: '#DCD6F7', // Soft Lavender
  },
  {
    name: 'May',
    noteKey: 'note.may',
  ...
  },
  {
    name: 'June',
    noteKey: 'note.june',
    captionKeys: ['caption.jun1', 'caption.jun2', 'caption.jun3', 'caption.jun4'],
    color: '#C54B6C', // Deep Rose
  },
  {
    name: 'July',
  ...
  },
  {
    name: 'August',
    noteKey: 'note.august',
    captionKeys: ['caption.aug1', 'caption.aug2', 'caption.aug3', 'caption.aug4'],
    color: '#FFB6C1', // Blush Pink
  },
  {
    name: 'September',
  ...
  },
  {
    ...
    captionKeys: ['caption.oct1', 'caption.oct2', 'caption.oct3', 'caption.oct4'],
    color: '#F7E7CE', // Champagne
  },
  {
    name: 'November',
  ...
  },
  {
    ...
    captionKeys: ['caption.dec1', 'caption.dec2', 'caption.dec3', 'caption.dec4'],
    color: '#E8A0BF', // Rose Gold
  },
]
